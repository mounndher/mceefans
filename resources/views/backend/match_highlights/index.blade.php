    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Match Highlights List</h3>
                <div class="card-actions">
                    <a href="{{ route('match_highlights.create') }}" class="btn btn-primary">
                        <!-- Plus icon -->
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('match_highlights.edit', $highlight->id) }}" class="btn-sm btn-primary">
                                        <!-- edit icon -->
                                    ...
                                    <form action="{{ route('match_highlights.destroy', $highlight->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-sm btn-danger" onclick="return confirm('Are you sure to delete this highlight?')">
                                            <!-- trash icon -->
