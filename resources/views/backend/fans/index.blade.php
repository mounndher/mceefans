            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="id_abonment" required>
                            <option value="">-- Sélectionner --</option>
                            @foreach($abonments as $abonment)
                                <option value="{{ $abonment->id }}">
                                    {{ $abonment->name }} - {{ $abonment->prix }} DA - {{ $abonment->nbrmatch }} matchs
                                </option>
                            @endforeach
                        </select>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            document.querySelector('#modal-renouveler .modal-title').textContent = 'Renouveler Abonnement - ' + fanName;
