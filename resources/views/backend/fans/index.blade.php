                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="ids[]" value="{{ $fan->id }}" class="fan-checkbox">
                                    </td>
                                    <td>{{ $fan->id_qrcode }}</td>
                                    <td>{{ $fan->nom }}</td>
                                    <td>{{ $fan->prenom }}</td>
                                    ...
                                    <td>
                                        ...
                                        <!-- Edit -->
                                        <a href="{{ route('fans.edit', $fan->id) }}" class="text-primary ms-2" title="Edit">✏️</a>

                                        <!-- PDF -->
                                        <a href="{{ route('fans.cardPdf', $fan->id) }}" target="_blank" class="btn btn-sm btn-danger ms-2">PDF</a>

                                        <!-- Delete -->
                                        <form action="{{ route('fans.destroy', $fan->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-link p-0 ms-2 text-danger" onclick="return confirm('Are you sure?')" title="Delete">🗑</button>
                                        </form>
