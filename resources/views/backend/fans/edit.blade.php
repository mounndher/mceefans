                    ...
                    <form action="{{ route('fans.update', $fan->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nin"
                                value="{{ old('nin', $fan->nin) }}">
                            <x-input-error :messages="$errors->get('nin')" class="mt-2" />
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Téléphone</label>
                            <input type="text" class="form-control" name="numero_tele"
                                value="{{ old('numero_tele', $fan->numero_tele) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="date_de_nai"
                                value="{{ old('date_de_nai', $fan->date_de_nai) }}">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($fan->image)
                                <img src="{{ asset('uploads/fans/'.$fan->image) }}" width="100" class="mb-2">
                            @endif
