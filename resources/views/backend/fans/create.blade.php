            ...
            <div class="card-body">
                <form action="{{ route('fans.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id_qrcode" value="{{ old('id_qrcode') }}" placeholder="Enter QR Code">
                        @error('id_qrcode')
                    ...
                    <div class="mb-3">
                        <label class="form-label">Image Carte</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="card" value="{{ old('card') }}" placeholder="Enter card info">
                        @error('card')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>

                    <!-- ✅ New Abonment Dropdown -->
                    <div class="mb-3">
