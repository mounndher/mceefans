            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('attendances.index') ? 'active' : '' }}" href="{{ route('attendances.index') }}">
                        ...
                        <span class="nav-link-title">Présence ticket</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('features.*') ? 'active' : '' }}" href="{{ route('features.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Tabler star icon (or any icon you prefer) -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#MatchMenu" role="button" aria-expanded="false" aria-controls="MatchMenu">
                        ...
                        <span class="nav-link-title">Match Highlights</span>
                    </a>
                    <div class="collapse" id="MatchMenu">
                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item"><a class="nav-link" href="{{ route('match_highlights.index') }}"> Match Highlights</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('match_highlights_text.index') }}">Match Highlights text
                                </a></li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.votrecart.*') ? 'active' : '' }}" href="{{ route('votrecart.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Tabler shopping-cart icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <span class="nav-link-title">Votre Cart</span>
                    </a>
                </li>
