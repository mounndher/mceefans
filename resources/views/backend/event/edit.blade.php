            ...
            <div class="card-body">
                <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nom" value="{{ old('nom', $event->nom) }}" placeholder="Enter event name">
                        @error('nom') <div class="text-danger small">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Subtitle</label>
                        <input type="text" class="form-control" name="subtitle" value="{{ old('subtitle', $event->subtitle) }}" placeholder="Enter subtitle">
                    ...
                    <div class="mb-3">
                        ...
                        @if($event->image_post)
                            <img src="{{ asset('/uploads/event/' . $event->image_post) }}" alt="Event Image" width="250">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="stade" value="{{ old('stade', $event->stade) }}" placeholder="Enter stade/location">
